...
Output Data
The resulting tidyMeansData.txt dataset includes mean and standard deviation variables for the following original variables:
...
Saves this last dataset to tidyMeansData.txt